...
#========================================================================================================#
#													 #
# [NYTEK'S  H:CA  DEV-ENV  INSTALL  SCRIPTi  v1] 							 #
...
#  out any unwanted package(s) by simply adding a "#" to the beginning of each respective line.          #
# -The OS Optimization script is only for Linux at this time. Furthermore, it can only be run ONE TIME   #
#  due to file changes being repeated otherwise. Using -t more than once will damage your system. 	 #
...
echo
echo "         ex. [For Linux]: bash hcaInstall.bash -l -t"
echo
echo

# using getopts to make the magic happen
#
lflag=
mflag=
tflag=
